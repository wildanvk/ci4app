        ...
        <div class="row align-items-center">
            <div class="col-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-muted">Produksi</a></li>
    ...
    <div class="col-12">
        <div class="card col-4">
            <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <h5 class="card-title fw-semibold mb-0 lh-sm me-2">Riwayat Produksi</h5>
                </div>
            </div>
            <div class="mx-4 my-3">
                <form action="/produksi/riwayatproduksi/cetak" method="post" target="_blank">
                    <div class="mb-3 row">
                        <div class="col-md-10">
                            <div>
        ...
        <div class="card">
            <div class="py-3" style="overflow-x: auto !important;">
                <table id="riwayatProduksiTable" class="table">
                    <thead class="bg-primary text-white">
                        <tr>
                            <th class="align-middle">No</th>
                            <th class="align-middle">ID Riwayat Produksi</th>
                            <th class="align-middle">ID Produksi</th>
                            <th class="align-middle">Nama Barang</th>
                            <th class="align-middle">Jumlah</th>
                            <th class="align-middle">Tanggal Produksi</th>
