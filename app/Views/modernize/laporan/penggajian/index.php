...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Laporan Penggajian</h4>
    ...
    <div class="col-12">
        <div class="card col-4">
            <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <h5 class="card-title fw-semibold mb-0 lh-sm me-2">Laporan Penggajian</h5>
                </div>
            </div>
            <div class="mx-4 my-3">
                <form action="/penggajian/laporan/cetak" method="post" target="_blank">
                    <div class="mb-3 row">
                        <div class="col-md-10">
                            <div>
        ...
        <div class="card">
            <div class="py-3" style="overflow-x: auto !important;">
                <table id="laporanPenggajianTable" class="table">
