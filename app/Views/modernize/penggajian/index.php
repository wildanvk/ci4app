                    ...
                    <?php foreach ($penggajian as $key => $row) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="<?php echo base_url('/penggajian/penggajian/edit/' . $row['idpenggajian']); ?>" class="btn btn-sm btn-info">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="fw-medium fs-4" style="text-align: left !important; line-height: 2em; !important">Apakah Anda yakin ingin menghapus data <span class="badge bg-primary"><?= $row['idpenggajian'] ?></span> dengan nama <span class="badge bg-primary"><?= $row['nama_karyawan'] ?></span>?</p>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="<?php echo base_url('/penggajian/penggajian/delete/' . $row['idpenggajian']); ?>" class="btn btn-light-danger text-danger font-medium">
                                                    Hapus Data
                                                </a>
