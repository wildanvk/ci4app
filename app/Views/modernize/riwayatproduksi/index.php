...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Riwayat Produksi</h4>
...
<div class="card w-100 position-relative overflow-hidden">
    <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
        <h5 class="card-title fw-semibold mb-0 lh-sm">Riwayat Produksi</h5>
        <a href="/riwayatproduksi/input" class="btn btn-primary font-medium">
        ...
        <table class="table">
            <thead class="bg-primary text-white">
                <tr>
                    ...
                    <th class="text-center">Id Riwayat Produksi</th>
                ...
                <?php } else { ?>
                    <?php foreach ($riwayatproduksi as $key => $row) : ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $row['id_riwayat_produksi']; ?></td>
                            <td class="text-center"><?php echo $row['id_produksi']; ?></td>
                            <td class="text-center"><?php echo $row['nama_barang']; ?></td>
                            <td class="text-center"><?php echo $row['jumlah']; ?></td>
                            <td class="text-center"><?php echo $row['tgl_produksi']; ?></td>
                            <td class="text-center"><?php echo $row['tgl_selesai']; ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php } ?>
            </tbody>
