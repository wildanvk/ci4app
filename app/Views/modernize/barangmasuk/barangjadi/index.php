...
<div class="card w-100 position-relative overflow-hidden">
    <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
        <h5 class="card-title fw-semibold mb-0 lh-sm">Data Transaksi Masuk Barang Mentah</h5>
        <a href="/barangmasukmentah/input" class="btn btn-primary font-medium">
        ...
        <table class="table">
            <thead class="bg-primary text-white">
                <tr>
                    ...
                    <th class="text-center">ID Barang Mentah</th>
                    <th class="text-center">Nama Barang Mentah</th>
            ...
            <tbody>
                <?php if (empty($barangmasukmentah)) { ?>
                    <tr>
                ...
                <?php } else { ?>
                    <?php foreach ($barangmasukmentah as $key => $row) : ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $row['idTransaksi']; ?></td>
                            <td class="text-center"><?php echo $row['idBarangMentah']; ?></td>
                            <td class="text-center"><?php echo $row['namaBarangMentah']; ?></td>
                            <td class="text-center"><?php echo $row['idSupplier']; ?></td>
                            <td class="text-center"><?php echo $row['namaSupplier']; ?></td>
                            <td class="text-center"><?php echo $row['jumlah']; ?></td>
                            <td class="text-center"><?php echo format_rupiah($row['harga']); ?></td>
                            <td class="text-center"><?php echo $row['keterangan']; ?></td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="<?php echo base_url('barangmasukmentah/edit/' . $row['idTransaksi']); ?>" class="btn btn-sm btn-info">
                                        <i class="ti ti-edit"></i>
                                        Update
                                    </a>
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal-hapus-<?= $row['idTransaksi'] ?>">
                                ...
                                <!-- Modal hapus -->
                                <div class="modal fade" id="modal-hapus-<?= $row['idTransaksi'] ?>" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="fw-medium fs-4" style="text-align: left !important; line-height: 2em; !important">Apakah Anda yakin ingin menghapus data transaksi masuk <span class="badge bg-primary"><?= $row['idTransaksi'] ?></span> dengan ID barang <span class="badge bg-primary"><?= $row['idBarangMentah'] ?></span> dan nama barang <span class="badge bg-primary"><?= $row['namaBarangMentah'] ?></span>?</p>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="<?php echo base_url('barangmasukmentah/delete/' . $row['idTransaksi']); ?>" class="btn btn-light-danger text-danger font-medium">
                                                    Hapus Data
                                                </a>
