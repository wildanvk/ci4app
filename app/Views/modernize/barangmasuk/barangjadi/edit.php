                ...
                <div class="col-sm-6">
                    <select class="form-select" name="idBarangMentah" id="idBarangMentah">
                        ...
                        <?php foreach ($barangmentah as $key) { ?>
                            <option value="<?= $key['idBarangMentah'] ?>" <?= old('idBarangMentah') == $key['idBarangMentah'] || $key['idBarangMentah'] == $key['idBarangMentah'] ? 'selected' : '' ?>><?= $key['idBarangMentah'] . ' - ' . $key['namaBarangMentah'] ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
                ...
                <div class="col-sm-6">
                    <select class="form-select" name="idSupplier" id="idSupplier">
                        ...
                        <?php foreach ($supplier as $key) { ?>
                            <option value="<?= $key['idSupplier'] ?>" <?= old('idSupplier') == $key['idSupplier'] || $key['idSupplier'] == $key['idSupplier'] ? 'selected' : '' ?>><?= $key['idSupplier'] . ' - ' . $key['namaSupplier'] ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
