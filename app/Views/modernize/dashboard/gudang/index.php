  ...
  <div class="owl-carousel counter-carousel owl-theme">
      ...
      <div class="card border-0 zoom-in bg-light-primary shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/svgs/supplier.png" class="mb-3 mx-auto"
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-primary shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/svgs/barang.png" class="mb-3 mx-auto"
              alt="" style="width: 50px !important;" />
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-warning shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/svgs/stok.png" class="mb-3 mx-auto"
              alt="" style="width: 50px !important;" />
            <p class="fw-semibold fs-3 text-warning mb-1">Stok Barang Mentah</p>
            <h5 class="fw-semibold text-warning mb-0">
              <?= $stokbarangmentah['stok'] ?>
            </h5>
          </div>
        </div>
      </div>
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-success shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/svgs/barang-keluar.png"
              class="mb-3 mx-auto" alt="" style="width: 50px !important;" />
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-danger shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="<?php echo base_url('modernize-bootstrap'); ?>/dist/images/svgs/barang-masuk.png"
              class="mb-3 mx-auto" alt="" style="width: 50px !important;" />
