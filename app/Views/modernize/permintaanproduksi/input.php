...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Input Permintaan Produksi</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" aria-current="page"><a href="/permintaanproduksi">Permintaan Produksi</a></li>
                        <li class="breadcrumb-item" aria-current="page">Input Permintaan Produksi</li>
                    </ol>
                </nav>
            </div>
            <div class="col-2">
    ...
    <form action="/produksi/permintaanproduksi/store" method="post">
        ...
        <div class="card-body p-4">
            <div class="mb-4 row align-items-center">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="id_produksi" placeholder="Masukkan ID Produksi" name="id_produksi" value="<?= $id_produksi ?>" readonly>
                </div>
            </div>
            <div class="mb-4 row align-items-center">
                <label for="nama_barang" class="form-label fw-semibold col-sm-1 col-form-label">Nama Barang</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="nama_barang" placeholder="Masukkan Nama Barang" name="nama_barang" value="">
                </div>
            </div>
            <div class="mb-4 row align-items-center">
                <label for="jumlah" class="form-label fw-semibold col-sm-1 col-form-label">Jumlah</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" id="jumlah" placeholder="Masukkan jumlah" name="jumlah" value="">
                </div>
            </div>
            <div class="row">
