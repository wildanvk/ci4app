...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Stok Barang Jadi</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="card-title fw-semibold mb-0 lh-sm">Data Stok Barang Jadi</h5>
            ...
            <div class="py-3" style="overflow-x: auto !important;">
                <table id="stokBarangJadiTable" class="table border table-striped display text-nowrap">
                        ...
                        <div class="modal-content">
                            <form id="updateForm">
                                ...
                                <div class="modal-body" style="text-align: left !important;">
                                    <input type="hidden" id="idStokBarangJadi" name="idStokBarangJadi" value="">
                                    <label for="stok" class="form-label fw-semibold col-form-label ms-1">Stok Barang :</label>
                            ...
                            <form id="deleteForm">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p class="fw-medium fs-4" style="text-align: left !important; line-height: 2em !important; ">
                                        ...
                                        <span class="badge bg-primary" id="spanIdStokBarangJadi"></span>
                                        dengan ID barang <span class="badge bg-primary" id="spanIdBarangJadi"></span>
                                        dan nama barang <span class="badge bg-primary" id="spanNamaBarangJadi"></span>?
                                    </p>
                                </div>
                                <div class="modal-footer">
...
<script src="<?php echo base_url('modernize-bootstrap'); ?>/dist/js/myjs/StokBarangJadiTable.js"></script>
<?= $this->endSection() ?>