...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Pembagian Produksi</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item" aria-current="page">Pembagian Produksi</li>
                    </ol>
                </nav>
            </div>
            <div class="col-2">
...
<div class="card w-100 position-relative overflow-hidden">
    <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
        <h5 class="card-title fw-semibold mb-0 lh-sm">Pembagian Produksi</h5>
    ...
    <div class="table-responsive" style="overflow-x: auto !important;">
        <table class="table">
            ...
            <tbody>
                ...
                <?php } else { ?>
                    <?php foreach ($datakaryawan as $key => $row) : ?>
                        <tr>
                            <td class="text-center"><?php echo $key + 1; ?></td>
                            <td class="text-center"><?php echo $row['id_karyawan']; ?></td>
                            <td><?php echo $row['nama_karyawan']; ?></td>
                            <td><?php echo $row['divisi/bagian']; ?></td>
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal-<?= $row['id_karyawan'] ?>">
                                ...
                                <div class="modal fade" id="modal-<?= $row['id_karyawan'] ?>" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="fw-medium fs-4" style="text-align: left !important; line-height: 2em; !important">Apakah Anda yakin ingin menghapus data datakaryawan <span class="badge bg-primary"><?= $row['id_karyawan'] ?></span> dengan nama datakaryawan <span class="badge bg-primary"><?= $row['nama_karyawan'] ?></span>?</p>
                                            </div>
