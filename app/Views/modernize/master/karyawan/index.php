                ...
                <?php } else { ?>
                    <?php foreach ($karyawan as $key => $row) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="<?php echo base_url('karyawan/edit/' . $row['idkaryawan']); ?>" class="btn btn-sm btn-info">
                                        <i class="ti ti-edit"></i>
                                        Update
                                    </a>
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal-<?= $row['idkaryawan'] ?>">
                                ...
                                <div class="modal fade" id="modal-<?= $row['idkaryawan'] ?>" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
