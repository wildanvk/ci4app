...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="px-4 py-3 d-flex border-bottom justify-content-between align-items-center">
                <h5 class="card-title fw-semibold mb-0 lh-sm">Data Supplier</h5>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="idSupplier" placeholder="Masukkan ID Supplier" name="idSupplier" value="<?= $idSupplier ?>" readonly>
            ...
            <div class="py-3" style="overflow-x:auto !important;">
                <table id="supplierTable" class="table border table-striped display text-nowrap">
                    <thead class="bg-primary text-white">
                        <!-- start row -->
                        <tr>
                            <th class="">No</th>
                            <th class="">ID Supplier</th>
                        ...
                        <?php } else { ?>
                            <?php foreach ($supplier as $key => $row) : ?>
                                <tr>
                                    ...
                                    <td class=""><?php echo $row['idSupplier']; ?></td>
                                ...
                                <div class="modal-body" style="text-align: left !important;">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <label for="idSupplier" class="form-label fw-semibold col-form-label ms-1">ID Supplier :</label>
                                                <input type="text" class="form-control" id="idSupplier" placeholder="Masukkan ID Supplier" name="idSupplier" value="" readonly>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            <div class="mb-3">
                                                <label for="namaSupplier" class="form-label fw-semibold col-form-label ms-1">Nama Supplier :</label>
                        ...
                        <div class="modal-content">
                            <form id="deleteForm">
                                ...
                                <div class="modal-body text-wrap">
                                    ...
                                    <p class="fw-medium fs-4" style="text-align: left !important; line-height: 2em !important; ">Apakah Anda yakin ingin menghapus data supplier <span class="badge bg-primary" id="spanIdSupplier"></span> dengan nama supplier <span class="badge bg-primary" id="spanNamaSupplier"></span>?</p>
                                </div>
                                <div class="modal-footer">
...
<script src="<?php echo base_url('modernize-bootstrap'); ?>/dist/js/myjs/SupplierTable.js"></script>
<?= $this->endSection() ?>