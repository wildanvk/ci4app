...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Barang Mentah</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="card-title fw-semibold mb-0 lh-sm">Data Barang Mentah</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <label for="idBarangMentah" class="form-label fw-semibold col-form-label ms-1">ID Barang Mentah :</label>
                                                <input type="text" class="form-control" id="idBarangMentah" placeholder="Masukkan ID Barang Mentah" name="idBarangMentah" value="<?= $idBarangMentah ?>" readonly>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            <div class="mb-3">
                                                <label for="namaBarangMentah" class="form-label fw-semibold col-form-label ms-1">Nama Barang Mentah :</label>
                                                <input type="text" class="form-control" id="namaBarangMentah" placeholder="Masukkan Nama Barang Mentah" name="namaBarangMentah" value="">
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            <div class="mb-3">
            ...
            <div class="py-3" style="overflow-x: auto !important;">
                <table id="barangMentahTable" class="table border table-striped display text-nowrap">
                    ...
                    <tbody>
                        <?php if (empty($barangmentah)) { ?>
                            <tr>
                                <td class="text-center" colspan="7">Tidak ada data</td>
                            </tr>
                        <?php } else { ?>
                            <?php foreach ($barangmentah as $key => $row) : ?>
                                <tr>
                                ...
                                <div class="modal-body" style="text-align: left !important;">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <label for="idBarangMentah" class="form-label fw-semibold col-form-label ms-1">ID Barang Mentah :</label>
                                                <input type="text" class="form-control" id="idBarangMentah" placeholder="Masukkan ID Barang Mentah" name="idBarangMentah" value="" readonly>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                            <div class="mb-3">
                                                <label for="namaBarangMentah" class="form-label fw-semibold col-form-label ms-1">Nama Barang Mentah :</label>
                        ...
                        <div class="modal-content">
                            <form id="deleteForm">
                                ...
                                <div class="modal-body text-wrap">
                                    ...
                                    <input type="hidden" id="idBarangMentah" name="idBarangMentah" value="">
                                    <p class="fw-medium fs-4" style="text-align: left !important; line-height: 2em !important; ">Apakah Anda yakin ingin menghapus data barang mentah <span class="badge bg-primary" id="spanIdBarangMentah"></span> dengan nama barang mentah <span class="badge bg-primary" id="spanNamaBarangMentah"></span>?</p>
                                </div>
                                <div class="modal-footer">
...
<script src="<?php echo base_url('modernize-bootstrap'); ?>/dist/js/myjs/BarangMentahTable.js"></script>
<?= $this->endSection() ?>