...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Progres Produksi</h4>
        ...
        <table class="table">
            <thead class="bg-primary text-white">
                <tr>
                    ...
                    <th class="text-center">Id Progres</th>
            ...
            <tbody>
                <?php if (empty($progresproduksi)) { ?>
                    <tr>
                        <td class="text-center" colspan="7">Tidak ada data</td>
                    </tr>
                <?php } else { ?>
                    <?php foreach ($progresproduksi as $key => $row) : ?>
                        <tr>
                            <td class="text-center"><?php echo $key + 1; ?></td>
                            <td class="text-center"><?php echo $row['id_progres']; ?></td>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal-<?= $row['id_progres'] ?>">
                                ...
                                <div class="modal fade" id="modal-<?= $row['id_progres'] ?>" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
